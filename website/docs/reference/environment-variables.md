...
| `E2B_API_KEY` | E2B cloud sandboxes ([e2b.dev](https://e2b.dev/)) |
...
| Variable | Description |
|----------|-------------|
| `TERMINAL_ENV` | Backend: `local`, `docker`, `ssh`, `singularity`, `modal`, `daytona`, `e2b`, `vercel_sandbox` |
...
| `TERMINAL_E2B_TEMPLATE` | E2B template alias or template ID |
